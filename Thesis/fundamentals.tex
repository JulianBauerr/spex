...
% ==========================================
\section{Fermionic Many-Body Systems}\label{sec:fermionic-many-body-systems}
...
To understand these very important operators more we can have a look at the Jordan Wigner (JW) Transformation, that maps fermionic spin orbitals to qubits.
...
\end{align}
All orbitals before the $k$-th must be left untouched which here is defined by $\mathbb{I}^{\otimes (k-1)}$.
