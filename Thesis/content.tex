...
\subsubsection{Unitary Operations and Generators}
...
\subsubsection{Indistinguishability and the Pauli Exclusion Principle}
...
\subsubsection{Wavefunction Symmetry and Antisymmetry}
...
\subsubsection{Distinctions Between Fermions and Qubits}
...
\subsubsection{Second Quantization and Fermionic Operators}
...
\subsubsection{The Jordan-Wigner Transformation}
...
\subsection{Quantum Excitation}
This principle unifies the preceding theoretical fundamentals, providing a mathematical framework to model the transitions of electrons between orbitals.

\subsubsection{Fermionic Excitation}
...
\cite[chapter III.A]{anand2022quantum}

\subsubsection{Qubit Excitations}
