...
This concept naturally extends to higher-order excitations. Given sets of target and occupied orbitals, denoted by vectors $\boldsymbol{k}$ and $\boldsymbol{l}$ respectively, the generator for a multiple-qubit excitation can be generalized as:
\begin{equation}
...
%% Switch fermionic and qubit excitation chapter?
